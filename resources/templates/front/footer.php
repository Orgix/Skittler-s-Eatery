...
<footer class="sktl text-light font-weight-bold">
  ...
  <div class="container text-center">
    <div class="row content">
      ...
      <div class="col-sm-12 order-3  mt-2 mt-md-0 d-block d-md-none">
      ...
      <div class="col-md-3 col-sm-4 order-md-2 d-none d-md-block">
        <p class="mb-4 text-white font-weight-bold">
          <u>RECENT NEWS</u>
        </p>
        <div id="col_1">
      ...
      <div class="col-md-3 col-sm-4 order-md-3 d-none d-md-block">
        <p class="mb-4 text-light font-weight-bold">
          <u>CATEGORIES</u>
        </p>
        <div id="col_2">
          <p class="text-light font-weight-bold" id="col_2">
